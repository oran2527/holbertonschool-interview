 ...
 * @aux_indx: array with index for word
 * @wordlen: word length
 * @idx_len: aux_indx length
 ...
 * @s: string base
 * @words: array of words to search in string
 * @nb_words: number of words
 * Return: array with substring size for word or NULL
 **/
...
/**
 * find_substring - search word in search_word
 * @s: string base
